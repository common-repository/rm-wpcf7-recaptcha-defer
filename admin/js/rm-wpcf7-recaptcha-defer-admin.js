...
(function( $ ) {
    ...
    $(function(){
         ...
         var frame,
             ...
             imgDelButton = $('#rm-wpcf7-recaptcha-defer-delete_logo_button'),
             // Color Pickers Inputs
             colorPickerInputs = $( '.rm-wpcf7-recaptcha-defer-color-picker' );

         // WordPress specific plugins - color picker and image upload
         $( '.rm-wpcf7-recaptcha-defer-color-picker' ).wpColorPicker();
